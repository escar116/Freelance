...
function renderReviewsProfile(reviews) {
  ...
  if (document.getElementById('ratings-total-count')) document.getElementById('ratings-total-count').textContent = `Based on ${reviews.length} review${reviews.length > 1 ? 's' : ''}`;
