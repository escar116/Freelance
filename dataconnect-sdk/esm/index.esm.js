...
export const listAllHelpRequestsAdminRef = (dc) => {
  const { dc: dcInstance} = validateArgs(connectorConfig, dc, undefined);
  dcInstance._useGeneratedSdk();
...
export function listAllApplicationsAdmin(dcOrOptions, options) {
